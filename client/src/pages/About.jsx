                ...
                <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                    ...
                    <div style={{ marginBottom: '4rem' }}>
                        ...
                        <p style={{ fontSize: '1.1rem', color: 'var(--text-secondary)', lineHeight: 1.8, marginBottom: '1.5rem' }}>
                            Founded in 2011, AMG Consulting started as a boutique strategy firm in Tech City. Over the last decade, we have evolved into a full-service digital transformation partner, serving clients across finance, healthcare, retail, and manufacturing.
                        </p>
                        <p style={{ fontSize: '1.1rem', color: 'var(--text-secondary)', lineHeight: 1.8 }}>
                    ...
                    <div className="card" style={{ background: '#f8fafc', border: 'none' }}>
                        <h3 style={{ marginBottom: '1.5rem' }}>AMG by the Numbers</h3>
